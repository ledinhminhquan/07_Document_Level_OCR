"""Lightweight model registry / versioning for the trained corrector.

Records training provenance next to each checkpoint and maintains a ``latest``
pointer so inference and the agent always resolve a single, reproducible version.
"""
