...
_REQUIRED_SRC = [
    "src/dococr/config.py", "src/dococr/cli.py",
    "src/dococr/models/corrector.py", "src/dococr/models/baseline.py",
    "src/dococr/data/ocr_noise.py", "src/dococr/models/ocr_engine.py",
    "src/dococr/ocr/preprocess.py", "src/dococr/ocr/layout.py",
    "src/dococr/training/train_corrector.py", "src/dococr/training/evaluate.py",
    "src/dococr/agent/doc_agent.py", "src/dococr/agent/policy.py", "src/dococr/api/main.py",
]
...
def build_checklist(repo_root) -> Dict:
    ...
    check("Baseline present (identity/dictionary)", (root / "src/dococr/models/baseline.py").is_file(), "baseline.py")
    check("Agent: 4 decision points (policy.py)", (root / "src/dococr/agent/policy.py").is_file(), "D1-D4")
